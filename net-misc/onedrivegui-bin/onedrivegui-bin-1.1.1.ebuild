...
SRC_URI="
    https://github.com/bpozdena/OneDriveGUI/releases/download/v1.1.1a/OneDriveGUI-1.1.1-x86_64.AppImage -> ${PN}-${PV}.AppImage
    https://github.com/bpozdena/OneDriveGUI/blob/v${PV}a/src/resources/images/OneDriveGUI.ico -> OneDriveGUI-${PV}.ico
"
