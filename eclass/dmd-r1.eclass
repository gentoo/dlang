...
#DEPEND=
# dmd doesn't link the runtime of the compiler used to build it so we
# don't RDEPEND on a Dlang implementation.
RDEPEND="${IDEPEND} net-misc/curl[${MULTILIB_USEDEP}]"
