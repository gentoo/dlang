...
# dlang-r1 should be created via dlang_gen_dep() function, using
...
# DEPEND="${DLANG_DEPS} $(dlang_gen_dep '
...
# dlang_gen_dep with DLANG_USEDEP placeholder instead.
#
# Example use:
# @CODE
...
# @OUTPUT_VARIABLE
# @DESCRIPTION:
# This is a placeholder variable supported by dlang_gen_dep, in order to
# depend on dlang-r1 packages built for the same Dlang implementation.
#
# Example use:
# @CODE
# RDEPEND="$(dlang_gen_dep '
...
_dlang_single_set_globals() {
	...
	if [[ ${DLANG_DEPS+1} ]]; then
		...
		DLANG_USEDEP='%DLANG_USEDEP-NEEDS-TO-BE-USED-IN-DLANG_GEN_DEP%'
...
# @FUNCTION: dlang_gen_dep
# @USAGE: <dependency>
# @DESCRIPTION:
# Output a list of <dependency>-ies facilitating specifying USE
# constraints specific to Dlang implementations.
#
...
# Example:
# @CODE
# DLANG_COMPAT=( gdc-13 ldc2-1_36 dmd-2_{101..106} )
# RDEPEND="$(dlang_gen_dep 'dev-libs/gtkd[${DLANG_USEDEP}]')"
# @CODE
#
# It will cause the variable to look like:
# @CODE
# RDEPEND="dlang_single_target_gdc-13? (
#     dev-libs/gtkd[dlang_targets_gdc-13(-),...] )
#  dlang_single_target_ldc2-1_36? (
#     dev-libs/gtkd[dlang_targets_ldc2-1_36(-),...] )
#  dlang_single_target_dmd-2_101? (
#     dev-libs/gtkd[dlang_targets_dmd-2_101(-),...] )
#  dlang_single_target_dmd-2_102? (
#     dev-libs/gtkd[dlang_targets_dmd-2_102(-),...] )
#  [...]
# "
# @CODE
dlang_gen_dep() {
